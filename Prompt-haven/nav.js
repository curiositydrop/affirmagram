...
(function () {
  ...
  <style>
    ...
    .menu a{display:inline-block;padding:8px 10px;margin:0 4px;border-radius:8px;text-decoration:none;color:#111}
    .menu a.active{font-weight:600;background:#eef6ff}
